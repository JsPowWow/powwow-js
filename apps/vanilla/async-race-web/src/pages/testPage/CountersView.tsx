...
export const CountersView = () => {
  return (
    <div class='window active' style='max-width: 400px'>
      <div class='title-bar'>
        <div class='title-bar-text'>Counters Demo</div>
      ...
      <div class='window-body has-space'>
        <menu role='tablist' aria-label='Window with Tabs'>
          <button role='tab' aria-controls='uncontrolled-counter' aria-selected='true'>
            Uncontrolled Counter
          </button>
          <button role='tab' aria-controls='controlled-counter'>
            Controlled Counter
          </button>
        </menu>
        <article role='tabpanel' id='uncontrolled-counter'>
          <p>
            Inspect the <code>Uncontrolled</code> counter available functionality
          </p>
