...
import { setupBrowserRouter } from '@powwow-js/fun-dom';
...
export class AppElement extends HTMLElement {
  ...
  connectedCallback() {
    ...
    <header>
      <h1>Example for Vanilla Routing</h1>
    </header>
    <nav>
      <ul>
        <li>
        ...
        <li>
          <a data-vanilla-route-link="spa" href="/about">About</a>
        </li>
        <li>
          <a data-vanilla-route-link="spa" href="/about/me?test=work#yes"
            >About Me</a
          >
        </li>
        <li>
          <a data-vanilla-route-link="spa" href="/learn">Learn</a>
          <ul>
            <li>
              <a
                data-vanilla-route-link="spa"
                href="/learn/js?list=es6&don=false#hello">
                JS</a
              >
              <ul>
                <li>
                  <a
                    data-vanilla-route-link="spa"
                    href="/learn/js/library-creation?topic=pnpm"
                    >Library Creation</a
                  >
                </li>
                <li>
                  <a
                    data-vanilla-route-link="spa"
                    href="/learn/js/library-publishing"
            ...
            <li>
              <a data-vanilla-route-link="spa" href="/learn/css?k=v">CSS</a>
              <ul></ul>
            </li>
          </ul>
        </li>
...
document.addEventListener('DOMContentLoaded', () => {
  setupBrowserRouter(routeConfig);
  //setupHashRouter(routeConfig);
});
